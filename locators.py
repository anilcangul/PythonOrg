...
class CommonPageLocators:
    ...
    PY3_DOC_BUTTON = (By.CSS_SELECTOR, "#documentation > ul > li.tier-2.super-navigation > p.download-buttons > a")
    SEARCH_RESULT_LIST = (By.XPATH, "//*[@id='content']/div/section/form/ul")
